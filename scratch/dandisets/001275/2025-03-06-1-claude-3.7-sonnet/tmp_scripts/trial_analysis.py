...
"""
Analysis of trial structure in Dandiset 001275: Mental navigation primate PPC
This script examines the trial data in more detail to understand the task structure.
"""
...
if np.any(valid_indices):
    ...
    for i, trial_idx in enumerate(valid_trial_indices):
        ...
        # Find hand position data within this trial
        trial_mask = (hand_times >= trial_start) & (hand_times <= trial_stop)
        trial_hand_times = hand_times[trial_mask]
        trial_hand_data = hand_data[trial_mask]
