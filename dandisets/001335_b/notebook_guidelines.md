...
Next, create and execute python scripts in the dandiset directory. The scripts can generate text output and plots. You won't be able to see the plots, but you can ask the user about them. You can also prompt the user for feedback. These scripts and plots will help inform you about what to put in the notebook. Feel free to make as many as you need to gather the information required to make a good notebook.
